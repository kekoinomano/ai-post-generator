                            ...
                            <div class="container">
                                ...
                                <div id="response-gpt3" style="display:none;">
                                    ...
                                    <div id="response-gpt3-buttons" class="d-flex my-5 justify-content-evenly">
                                        ...
                                        <button class="btn btn-lg btn-success w-auto" id="gpt3-button-draft" data-type="draft">Draft</button>
                                        <button class="btn btn-lg btn-primary w-auto" id="gpt3-button-create" data-type="publish">Publish</button>
                                    </div>
                                </div>
                            </div>
                        </div>
